...
class Adapter_TarjetaNosotros(private val estudiantes: Array<String>, private val onItemClickListener: onItemClick) : RecyclerView.Adapter<Adapter_TarjetaNosotros.ViewHolder>() {
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, i: Int) {
        ...
        viewHolder.itemNoCtrl.text = estudiantes[i]
        viewHolder.itemCarrera.text = estudiantes[i]
    }
